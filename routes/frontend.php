...
Route::get('tim-kiem.html', [FeProductCatalogueController::class, 'search'])->name('product.catalogue.search.html');

Route::get('tim-kiem/trang-{page}', [FeProductCatalogueController::class, 'search'])->name('product.catalogue.search')->where('page', '[0-9]+');
Route::get('tim-kiem/trang-{page}.html', [FeProductCatalogueController::class, 'search'])->name('product.catalogue.search.html')->where('page', '[0-9]+');
